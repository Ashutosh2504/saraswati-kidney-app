...
import com.example.healthifyapp.ashutoshseven.Cities4;
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              try {
                  ...
                  Toast.makeText(Breakfast.this, "Add diet Successfully"+Time, Toast.LENGTH_SHORT).show(); // Due to no response from get from api but data is stored.. 200 code is returned and check log for response
