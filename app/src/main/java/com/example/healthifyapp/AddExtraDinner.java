    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(AddExtraDinner.this, "Add diet Successfully" + kcalstext.getText().toString(), Toast.LENGTH_SHORT).show(); // Due to no response from get from api but data is stored.. 200 code is returned and check log for response
...
//        DietApi dietApi=retrofit.create(DietApi.class);
  ...
  /*  private void getItemDiet(String s) {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        Toast.makeText(AddExtraDinner.this, "Selected Item is: \t" + dinnerr, Toast.LENGTH_LONG).show();
        SharedPreference.saveSharedSetting(AddExtraDinner.this, "extra_dinner", dinnerr);
    }
}